    ...
    {({ handleChange, handleBlur, handleSubmit, values, touched, errors, isValid, isSubmitting }) => (
      <View style={formStyle.formStyle}>
        ...
        <TextInput
          ...
          blurOnSubmit={false}
        />
        {touched.email && errors.email && <Text variant="bodySmall" style={{ color: theme.colors.error }}>{errors.email}</Text>}
        ...
        <TextInput
          ...
          blurOnSubmit={false}
        />
        {touched.password && errors.password && <Text variant="bodySmall" style={{ color: theme.colors.error }}>{errors.password}</Text>}
        ...
        />
        {touched.confirmPassword && errors.confirmPassword && <Text variant="bodySmall" style={{ color: theme.colors.error }}>{errors.confirmPassword}</Text>}
